...
{
  "question": "¿Qué tipo de control usa TCP para evitar saturar el buffer del receptor?",
  "options": [
    "Control de flujo, usando el campo Window Size.",
    "Control de congestión, usando el campo cwnd.",
    "Control de errores, usando el campo Checksum.",
    "Control de acceso al medio, usando CSMA/CD."
  ],
  "answer": 0,
  "explanation": "El control de flujo lo maneja el receptor con Window Size. Le dice al emisor cuánto espacio libre tiene en su Buffer de Recepción para evitar que lo sature."
},
{
  "question": "¿Qué tipo de control usa TCP para evitar saturar la red y los routers?",
  "options": [
    "Control de flujo con Window Size.",
    "Control de congestión con Congestion Window (cwnd).",
    "Control de enlace con FCS.",
    "Control de sesión con el 3-Way Handshake."
  ],
  "answer": 1,
  "explanation": "El control de congestión lo maneja el emisor con su ventana cwnd. Si detecta pérdida de paquetes, reduce cwnd para no saturar la red."
},
{
  "question": "Si el receptor envía Window Size = 0, ¿qué hace el emisor?",
  "options": [
    "Cierra la conexión con un RST.",
    "Sigue enviando datos pero más lento.",
    "Se detiene y espera un nuevo ACK con ventana > 0.",
    "Fragmenta los paquetes a 1 byte."
  ],
  "answer": 2,
  "explanation": "Window = 0 se llama Zero Window. El emisor se frena porque el buffer del receptor está lleno. Manda Window Probes periódicamente para ver si ya hay espacio."
}
